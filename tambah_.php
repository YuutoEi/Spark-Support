...
//input ke data base
mysqli_query($koneksi, "insert into support VALUES ('', '$Nama','$Email','$JenjangPendidikan','$JenisKelamin','$Menemukan1','$Pertanyaan1','$Pertanyaan2','$Pertanyaan3','$Pertanyaan4','$Saran');");
